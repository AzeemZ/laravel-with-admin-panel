            ...
            <div class="card">
                ...
                <div class="comment-widgets scrollable">
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2">
                            <picture>
                                <source srcset="{{ url('assets/images/users/3.webp') }}" class="rounded-circle">
                                <img src="{{ url('assets/images/users/3.jpg') }}" alt="user" width="50" class="rounded-circle">
                            </picture>
                        </div>
                        <div class="comment-text w-100">
                            <h6 class="font-medium">Johnathan Doeting</h6>
                    ...
                    <div class="tab-pane active" id="home" role="tabpanel">
                        <div class="p-20">
                            ...
                            <picture>
                                ...
                                <img src="{{ url('assets/images/background/img4.jpg') }}" alt="background image" class="img-fluid">
                            </picture>
                        </div>
                    </div>
