        ...
        <div class="col-md-6">
                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea id="cono1" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="single-select" class="col-md-3 m-t-15">Single Select</label>
                        <div class="col-md-9">
                            <select id="single-select" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                    ...
                    <div class="form-group row">
                        <label for="multiple-select" class="col-md-3 m-t-15">Multiple Select</label>
                        <div class="col-md-9">
                            <select id="multiple-select" class="select2 form-control m-t-15" multiple="multiple" style="height: 36px;width: 100%;">
                                <optgroup label="Alaskan/Hawaiian Time Zone">
                                    <option value="AK">Alaska</option>
                                    <option value="HI">Hawaii</option>
                                </optgroup>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <input id="datepicker" type="text" class="form-control mydatepicker" placeholder="mm/dd/yyyy">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                        </div>
                    </div>
                    <label for="datepicker-autoclose" class="m-t-15">Autoclose Datepicker</label>
                    <div class="input-group">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group m-t-20">
                        <label for="date-mask">Date Mask <small class="text-muted">dd/mm/yyyy</small></label>
                        <input type="text" class="form-control date-inputmask" id="date-mask" placeholder="Enter Date">
                    </div>
                    <div class="form-group">
                        <label for="phone-mask">Phone <small class="text-muted">(999) 999-9999</small></label>
                        <input type="text" class="form-control phone-inputmask" id="phone-mask" placeholder="Enter Phone Number">
                    </div>
                    <div class="form-group">
                        <label for="international-mask">International Number <small class="text-muted">+19 999 999 999</small></label>
                        <input type="text" class="form-control international-inputmask" id="international-mask" placeholder="International Phone Number">
                    </div>
                    <div class="form-group">
                        <label for="xphone-mask">Phone / xEx <small class="text-muted">(999) 999-9999 / x999999</small></label>
                        <input type="text" class="form-control xphone-inputmask" id="xphone-mask" placeholder="Enter Phone Number">
                    </div>
                    <div class="form-group">
                        <label for="purchase-mask">Purchase Order <small class="text-muted">aaaa 9999-****</small></label>
