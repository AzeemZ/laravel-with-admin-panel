            ...
            <div class="card">
                ...
                <div class="comment-widgets scrollable">
                    ...
                    <div class="d-flex flex-row comment-row m-t-0">
                        <div class="p-2">
                            <picture>
                                <source srcset="{{ url('assets/images/users/1.webp') }}" class="rounded-circle">
                                <img src="{{ url('assets/images/users/1.jpg') }}" alt="user" width="50" class="rounded-circle">
                            </picture>
                        </div>
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2">
                            <picture>
                                <source srcset="{{ url('assets/images/users/4.webp') }}" class="rounded-circle">
                                <img src="{{ url('assets/images/users/4.jpg') }}" alt="user" width="50" class="rounded-circle">
                            </picture>
                        </div>
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2">
                            <picture>
                                <source srcset="{{ url('assets/images/users/5.webp') }}" class="rounded-circle">
                                <img src="{{ url('assets/images/users/5.jpg') }}" alt="user" width="50" class="rounded-circle">
                            </picture>
                        </div>
                        <div class="comment-text w-100">
                        ...
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item todo-item" data-role="task">
                                ...
                                <ul class="list-style-none assignedto">
                                    <li class="assignee">
                                        <picture>
                                            <source class="rounded-circle" srcset="{{ url('assets/images/users/1.webp') }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave">
                                            <img class="rounded-circle" width="40" src="{{ url('assets/images/users/1.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave">
                                        </picture>
                                    </li>
                                    <li class="assignee">
                                        <picture>
                                            <source class="rounded-circle" srcset="{{ url('assets/images/users/2.webp') }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica">
                                            <img class="rounded-circle" width="40" src="{{ url('assets/images/users/2.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica">
                                        </picture>
                                    </li>
                                    <li class="assignee">
                                        <picture>
                                            <source class="rounded-circle" srcset="{{ url('assets/images/users/3.webp') }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka">
                                            <img class="rounded-circle" width="40" src="{{ url('assets/images/users/3.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka">
                                        </picture>
                                    </li>
                                    <li class="assignee">
                                        <picture>
                                            <source class="rounded-circle" srcset="{{ url('assets/images/users/4.webp') }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina">
                                            <img class="rounded-circle" width="40" src="{{ url('assets/images/users/4.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina">
                                        </picture>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <div class="chat-box scrollable" style="height:475px;">
                        ...
                        <ul class="chat-list">
                            ...
                            <li class="chat-item">
                                <div class="chat-img">
                                    <picture>
                                        <source srcset="{{ url('assets/images/users/1.webp') }}">
                            ...
                            <li class="chat-item">
                                <div class="chat-img">
                                    <picture>
                                        <source srcset="{{ url('assets/images/users/2.webp') }}">
                            ...
                            <li class="chat-item">
                                <div class="chat-img">
                                    <picture>
                                        <source srcset="{{ url('assets/images/users/3.webp') }}">
                ...
                <div class="tab-content tabcontent-border">
                    <div class="tab-pane active" id="home" role="tabpanel">
                        <div class="p-20">
                            ...
                            <picture>
                                <source srcset="{{ url('assets/images/background/img4.webp') }}" class="img-fluid">
                                <img src="{{ url('assets/images/background/img4.jpg') }}" class="img-fluid" alt="background image">
                            </picture>
                        </div>
                    </div>
